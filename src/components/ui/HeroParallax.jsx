...
const HeroParallax = ({ products }) => {
  ...
  return (
    <div
      ref={ref}
      className="min-h-screen py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] bg-black opacity-100"
    >
