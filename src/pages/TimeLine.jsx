    ...
    return (
        <Layout>
            <div className="flex flex-col md:flex-row mt-20 items-center gap-5 justify-center">
                <div className="my-6 w-full md:w-1/2 h-screen bg-contain bg-center bg-no-repeat" style={{ backgroundImage: `url(${sch1})` }}></div>
                <div className="my-6 w-full md:w-1/2 h-screen bg-contain bg-center bg-no-repeat" style={{ backgroundImage: `url(${sch2})` }}></div>
