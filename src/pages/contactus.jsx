          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <ContactCard
                ...
                phone="+91 84271 46574"
                accent="cyan"
              />
              <ContactCard
                title="Student Co-convener"
                name="Shubham Mangal"
                phone="+91 78349 75811"
                accent="emerald"
              />
              <ContactCard
                title="Student Co-convener"
                name="Vedansh Singh"
                phone="+91 88268 73264"
                accent="cyan"
              />
              <ContactCard
            ...
            <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <a href="mailto:esummitpr.pec@gmail.com" className="block text-emerald-400 hover:text-emerald-300 transition-colors">
              ...
              <div className="flex justify-center space-x-6 mt-8">
                <a href="#" className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-all">
